package eu.carryT.rider.Fragments;
...
import eu.carryT.rider.Activities.CustomGooglePlacesSearch;
import eu.carryT.rider.Activities.HistoryActivity;
import eu.carryT.rider.Activities.Payment;
import eu.carryT.rider.Activities.ShowProfile;
import eu.carryT.rider.Helper.ConnectionHelper;
import eu.carryT.rider.Helper.CustomDialog;
import eu.carryT.rider.Helper.DataParser;
import eu.carryT.rider.Helper.SharedHelper;
import eu.carryT.rider.Helper.URLHelper;
import eu.carryT.rider.Models.CardInfo;
import eu.carryT.rider.Models.Driver;
import eu.carryT.rider.Models.PlacePredictions;
import eu.carryT.rider.TranxitApplication;
import eu.carryT.rider.Utils.MapAnimator;
import eu.carryT.rider.Utils.MapRipple;
import eu.carryT.rider.Utils.MyBoldTextView;
import eu.carryT.rider.Utils.MyButton;
import eu.carryT.rider.Utils.MyTextView;
import eu.carryT.rider.Utils.ResponseListener;
import eu.carryT.rider.Utils.Utilities;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.login, object, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (response != null && response.data != null) {
                    ...
                    utils.GoToBeginActivity((AppCompatActivity) getActivity());
                }
            }
        }) {
            @Override
