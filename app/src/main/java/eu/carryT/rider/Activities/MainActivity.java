...
import eu.carryT.rider.Fragments.Coupon;
import eu.carryT.rider.Fragments.Help;
import eu.carryT.rider.Fragments.HomeFragment;
import eu.carryT.rider.Fragments.Payment;
import eu.carryT.rider.Fragments.Wallet;
import eu.carryT.rider.Fragments.YourTrips;
...
import eu.carryT.rider.Utils.CustomTypefaceSpan;
import eu.carryT.rider.Utils.MyTextView;
import eu.carryT.rider.Utils.ResponseListener;

import static eu.carryT.rider.TranxitApplication.trimMessage;
...
public class MainActivity extends AppCompatActivity implements HomeFragment.HomeFragmentListener, ResponseListener {
    ...
    public AppCompatActivity activity = MainActivity.this;
