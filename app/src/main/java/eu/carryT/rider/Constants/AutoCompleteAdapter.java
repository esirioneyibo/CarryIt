...
import eu.carryT.rider.Models.PlaceAutoComplete;
...
public class AutoCompleteAdapter extends ArrayAdapter<PlaceAutoComplete> {
    ...
    public AutoCompleteAdapter(Context context, List<PlaceAutoComplete> modelsArrayList, AppCompatActivity activity) {
